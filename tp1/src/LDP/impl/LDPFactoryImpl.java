...
public class LDPFactoryImpl extends EFactoryImpl implements LDPFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case LDPPackage.VARIABLE: return createVariable();
			case LDPPackage.INIT_VARIABLE: return createInitVariable();
			case LDPPackage.CREATE_OBJECT: return createCreateObject();
			case LDPPackage.CALL_METHOD: return createCallMethod();
			default:
	 ...
	 */
	@Override
	public InitVariable createInitVariable() {
		InitVariableImpl initVariable = new InitVariableImpl();
		return initVariable;
	}
	...
	public CallMethod createCallMethod() {
		CallMethodImpl callMethod = new CallMethodImpl();
		return callMethod;
	}
