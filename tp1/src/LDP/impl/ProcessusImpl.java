 ...
 * </p>
 * <ul>
 *   <li>{@link LDP.impl.ProcessusImpl#getNom <em>Nom</em>}</li>
...
public class ProcessusImpl extends MinimalEObjectImpl.Container implements Processus {
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDPPackage.PROCESSUS__NOM, oldNom, nom));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDPPackage.PROCESSUS__NOM:
				return getNom();
			case LDPPackage.PROCESSUS__ACTIVITES:
				return getActivites();
			case LDPPackage.PROCESSUS__DEBUT:
